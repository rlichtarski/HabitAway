...
/// Firebase implementation of the [AuthenticationClient] interface.
/// {@endtemplate}
class FirebaseAuthenticationClient implements AuthenticationClient {
  ...
  /// Throws [LogInWithGoogleCanceled] if the flow is canceled by the user.
  ...
  /// Logs out the user which will emit
  /// [AuthenticationUser.anonymous] from the [user] Stream.
  ///
  /// Throws [LogOutFailure] if an exception occurs.
  @override
  ...
  /// Throws [UpdateProfileFailure] if an exception occurs.
  @override
  ...
  Future<void> signUpWithPassword({
    ...
    try {
      ...
      if (user == null) throw const SignUpWithPasswordFailure('User is null');
